...
if(!$berechtigung->isBerechtigt("stgv/editFoerdervertrag",null,"suid"))
{
    $error = array("message"=>"Sie haben nicht die Berechtigung um Föerderverträge anzulegen oder zu editieren.", "detail"=>"stgv/editFoerdervertrag");

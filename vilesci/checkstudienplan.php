...
if($studienplan->studienplan_id!='')
{
	...
	$output .= 'Bitte die Änderungen gemäß dem <a href="https://wiki.fhcomplete.org/doku.php?id=addons:stgvt-sto_content" target="_blank">vorgesehenen Schema</a> vornehmen</h2>';
	$qry = "SELECT
				tbl_lehrveranstaltung.bezeichnung, tbl_studienplan_lehrveranstaltung.semester
			FROM
				lehre.tbl_studienplan
	...
	// Pruefen ob ECTS>=SWS
	$output .= '<br><br><br><h2>'.++$nummerierung.'. Bei folgenden LVs sind die ECTS &lt; SWS (Siehe <a href="https://wiki.fhcomplete.org/doku.php?id=addons:stgvt-sto-content-attr#berechnungsbeispiele" target="_blank">Berechnungsbeispiele</a>)<br>
	...
	// Pruefen ob ALVS>=LVS
	$output .= '<br><br><br><h2>'.++$nummerierung.'. Bei folgenden LVs sind die ALVS &lt; LVS (Siehe <a href="https://wiki.fhcomplete.org/doku.php?id=addons:stgvt-sto-content-attr#berechnungsbeispiele" target="_blank">Berechnungsbeispiele</a>)<br>
	Falls keine Änderungen möglich sind, eine EMail an <a href="mailto: fhcomplete@'.DOMAIN.'">fhcomplete@'.DOMAIN.'</a> übermitteln</h2>';
	$qry = "SELECT
				tbl_lehrveranstaltung.bezeichnung, tbl_studienplan_lehrveranstaltung.semester,
	...
	$output .= '<br><br><br><h2>'.++$nummerierung.'. Bei folgenden LVs sind die LVPLS &gt; ALVS (Siehe <a href="https://wiki.fhcomplete.org/doku.php?id=addons:stgvt-sto-content-attr#berechnungsbeispiele" target="_blank">Berechnungsbeispiele</a>)<br>
	...
	$output .= '<br><br><br><h2>'.++$nummerierung.'. Bei folgenden LVs sind LAS &gt; ALVS. (Siehe <a href="https://wiki.fhcomplete.org/doku.php?id=addons:stgvt-sto-content-attr#berechnungsbeispiele" target="_blank">Berechnungsbeispiele</a>)<br>
